...
<section class="custom-bg py-6 text-center text-[#5A72A0] space-x-">
  ...
  <section class="p-10 max-w-4xl mx-auto mt-4">
   ...
   <!-- Mulai Form -->
   <form action="submit-gd-mahasiswa.php" method="POST" enctype="multipart/form-data">
    <!-- Question 1 -->
    ...
    <div class="mb-6 bg-[#FEF9D9] p-4 rounded-md">
      ...
      <div class="flex flex-col space-y-4 ml-6">
        <label class="flex items-center">
          ...
          <span class="ml-2 text-[#5A72A0] text-xm">Biaya Pendidikan (Biaya Semester, SPP, dll)</span>
        </label>
        <label class="flex items-center">
          <input type="radio" name="tujuan" class="form-radio text-blue-600">
          <span class="ml-2 text-[#5A72A0] text-xm">Kebutuhan Perkuliahan (Laptop, Handphone, Peralatan Studi, dll)</span>
        </label>
        <label class="flex items-center">
          <input type="radio" name="tujuan" class="form-radio text-blue-600">
          <span class="ml-2 text-[#5A72A0] text-xm">Kebutuhan Darurat (Kesehatan, dll)</span>
        </label>
      </div>
    </div>
