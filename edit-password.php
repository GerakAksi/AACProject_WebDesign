...
<body>
    ...
    <div class="flex justify-center items-start min-h-screen mt-[-2rem]">
        <div class="bg-white p-6 rounded-lg shadow-lg max-w-4xl w-full flex">
            ...
            <!-- Main Content -->
            <div class="flex flex-col items-start w-3/4 pl-6"> <!-- Use flexbox for vertical alignment -->
                <div class="mb-4"> <!-- Wrap heading and description in a div -->
                    <h3 class="text-xm font-semibold text-[#5A72A0]">Ganti Password</h3>
                    <p class="text-xs text-[#5A72A0]">Ganti Password anda</p>
                </div>
                <form action="ganti-password.php" method="POST" class="max-w-lg w-full"> <!-- Added max-width and width -->
                    <div class="mb-4"> <!-- No margin left for alignment -->
                        <label for="password" class="block text-[#5A72A0] font-semibold text-xs mb-1">Masukkan Password Baru</label>
                        <input type="password" id="password" name="password" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#5A72A0]" required>
                    </div>
                    <div class="mb-4"> <!-- No margin left for alignment -->
                        <label for="confirm-password" class="block text-[#5A72A0] font-semibold text-xs mb-1">Konfirmasi Password</label>
                        <input type="password" id="confirm-password" name="confirm-password" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#5A72A0]" required>
                    </div>
                    <button type="submit" class="bg-[#FEF9D9] text-[#5A72A0] font-semibold py-2 px-4 rounded-lg hover:bg-yellow-100 transition duration-300">Simpan Perubahan</button>
                </form>
            </div>
        </div>
    </div>
