...
<body>
    ...
    <section class="container mx-auto py-12">
        ...
        <script>
            // Simulate a login status check (this would typically come from your server or authentication system)
            var isLoggedIn = false;  // Change to 'true' when the user is logged in
        
            // Event listener for the first button (Jaga Satwa UNESA)
            document.getElementById("donate1").addEventListener("click", function() {
                if (isLoggedIn) {
                    // If logged in, redirect to the donation page
