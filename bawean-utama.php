    ...
    <main class="max-w-4xl mx-auto my-4">
        ...
        <section class="relative p-8">
            <div class="flex justify-end space-x-10 items-start"> <!-- justify-end menggeser konten ke kanan -->
                <!-- Gambar Luna -->
                <img src="img/3 RELAWAN PULAU BAWEAN.jpg" alt="Luna" class="w-56 h-56 object-cover rounded-lg border border-[#5A72A0]"> 
                ...
                <div class="flex-1 max-w-md">
                    ...
                    <script>
                        ...
                        const donasiUrl = 'bawean-donasi.php'; // Ganti dengan URL donasi yang sesuai
            ...
            <div class="bg-white p-8 rounded-lg shadow-lg inline-block flex-col">
                ...
                <div class="flex-1">
                    ...
                    <div id="kisah-content" style="display: block;">
                        ...
                        <p style="color: #5A72A0; text-indent: 0.5in; text-align: justify; margin-bottom: 1em;">
                            Setelah adanya survei, Tim SMCC dan UKM-PK berencana melakukan beberapa upaya kepada korban bencana gempa dengan melakukan edukais konseling bersama ibu - ibu atau lansia, mengadakan fun-games untuk anak - anak, dan pemberian donasi baik uang maupun barang.                        </p>
                        <p style="color: #5A72A0; text-indent: 0.5in; text-align: justify; margin-bottom: 1em;">
                        ...
                        <ul class="mt-4 space-y-4">
                            <li class="flex justify-between items-center border-b border-[#5A72A0] pb-2 mb-2">
                                <div class="flex items-center">
                                    <img src="img/1 TIM MEDIS.png" alt="Jasa Periksa Dokter" class="w-5 h-5 mr-4" />
                                    <span class="text-[#5A72A0]">Tim Medis</span>
                                </div>
                                <span class="text-[#5A72A0]">Rp 5.000.000</span>
                            </li>
                            <li class="flex justify-between items-center border-b border-[#5A72A0] pb-2 mb-2">
                                <div class="flex items-center">
                                    <img src="img/2 OBAT-OBATAN.png" alt="Rawat Inap" class="w-5 h-5 mr-4" />
                                    <span class="text-[#5A72A0]">Obat - obatan</span>
                                </div>
                                <span class="text-[#5A72A0]">Rp 4.000.000</span>
                            </li>
                            <li class="flex justify-between items-center border-b border-[#5A72A0] pb-2 mb-2">
                                <div class="flex items-center">
                                    <img src="img/MAKANAN DAN MINUMAN.png" alt="Rontgen Kaki" class="w-5 h-5 mr-4" />
                                    <span class="text-[#5A72A0]">Makanan & Minuman</span>
                                </div>
                                <span class="text-[#5A72A0]">Rp 6.000.000</span>
                            </li>
                            <li class="flex justify-between items-center border-b border-[#5A72A0] pb-2 mb-2">
                                <div class="flex items-center">
                                    <img src="img/4 PAKAIAN.png" alt="Pasang PEN" class="w-5 h-5 mr-4" />
                                    <span class="text-[#5A72A0]">Pakaian</span>
                                </div>
                                <span class="text-[#5A72A0]">Rp 2.500.000</span>
                            </li>
                            <li class="flex justify-between items-center border-b border-[#5A72A0] pb-2 mb-2">
                                <div class="flex items-center">
                                    <img src="img/5 TENDA PENGUNGSIAN.png" alt="Obat Minum" class="w-5 h-5 mr-4" />
                                    <span class="text-[#5A72A0]">Penyediaan Tempat Pengungsian</span>
                                </div>
                                <span class="text-[#5A72A0]">Rp 2.500.000</span>
                            </li>
                        </ul>
