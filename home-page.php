    ...
    <script>
        function searchDonation() {
            ...
            if (query.includes("pendidikan")) {
                window.location.href = "gap.php"; // Ganti dengan URL halaman donasi pendidikan
            } else if (query.includes("sosial")) {
                window.location.href = "gas.php"; // Ganti dengan URL halaman donasi kesehatan
            } else if (query.includes("hewan")) {
                window.location.href = "gah.php"; // Ganti dengan URL halaman donasi bencana
            } else if (query.includes("lingkungan")){
                window.location.href ="gal.php";
            } else if(query.includes("kemanusiaan")){
                window.location.href ="gak.php"
            }else {
        ...
        <div class="bg-[#FEF9D9] shadow-lg rounded-lg py-8 px-12 max-w-4xl mx-auto">
            ...
            <div class="grid grid-cols-3 gap-6">
                ...
                <div class="bg-white p-6 rounded-lg shadow">
                    ...
                    <p id="donation-amount-1" class="text-sm text-[#5A72A0] mb-2 text-left">Rp 500,000 terkumpul dari Rp 5,000,000</p>
                    <button class="bg-[#FEF9D9] text-[#5A72A0] px-4 py-2 mt-4 rounded-full w-full donate-button" data-campaign-id="1">Donasi</button>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow">
                    ...
                    <p id="donation-amount-2" class="text-sm text-[#5A72A0] mb-2 text-left">Rp 1,200,000 terkumpul dari Rp 10,000,000</p>
                    <button class="bg-[#FEF9D9] text-[#5A72A0] px-4 py-2 mt-4 rounded-full w-full donate-button" data-campaign-id="2">Donasi</button>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow">
                    ...
                    <p id="donation-amount-3" class="text-sm text-[#5A72A0] mb-2 text-left">Rp 500,000 terkumpul dari Rp 5,000,000</p>
                    <button class="bg-[#FEF9D9] text-[#5A72A0] px-4 py-2 mt-4 rounded-full w-full donate donate-button" data-campaign-id="3">Donasi</button>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow">
                    ...
                    <p  id="donation-amount-4" class="text-sm text-[#5A72A0] mb-2 text-left">Rp 1.500,000 terkumpul dari Rp 5,000,000</p>
                    <button class="bg-[#FEF9D9] text-[#5A72A0] px-4 py-2 mt-4 rounded-full w-full donate-button" data-campaign-id="4">Donasi</button>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow">
                    ...
                    <p id="donation-amount-5" class="text-sm text-[#5A72A0] mb-2 text-left">Rp 400,000 terkumpul dari Rp 5,000,000</p>
                    <button class="bg-[#FEF9D9] text-[#5A72A0] px-4 py-2 mt-4 rounded-full w-full donate-button" data-campaign-id="5">Donasi</button>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow">
                    ...
                    <p  id="donation-amount-6"  class="text-sm text-[#5A72A0] mb-2 text-left">Rp 500,000 terkumpul dari Rp 5,000,000</p>
                    <button class="bg-[#FEF9D9] text-[#5A72A0] px-4 py-2 mt-4 rounded-full w-full donate-button" data-campaign-id="6">Donasi</button>
                </div>
            </div>
        </div>
    </section>
    ...
    donateButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            if (campaignId === '1') {
                ...
                window.location.href = 'jaga-satwa-donasi.php';
            } else if (campaignId === '3') {
                window.location.href = 'bawean-donasi.php';
            } else if (campaignId === '4') {
                window.location.href = 'time-to-heal-donasi.php';
            } else if (campaignId === '5') {
                window.location.href = 'luna-donasi.php';
            } else if (campaignId === '6') {
                window.location.href = 'peduli-lumajang-donasi.php';
            }
        });
    });
</script>
    ...
    <section class="container mx-auto py-8 text-center">
        ...
        <script>
            ...
            document.getElementById('donasiButton').addEventListener('click', function() {
                window.location.href = 'donasi-saya.php'; // Ganti dengan URL tujuan
            });
            ...
            document.getElementById('galangDanaButton').addEventListener('click', function() {
                window.location.href = 'galang-dana.php'; // Ganti dengan URL tujuan
            });
        </script>
    ...
    <script>
        ...
        document.getElementById('viewMoreButton').addEventListener('click', function (event) {
            ...
            if (hasUpdates) {
                ...
                window.location.href = 'halaman-baru.php'; // Ganti dengan URL tujuan
            } else {
