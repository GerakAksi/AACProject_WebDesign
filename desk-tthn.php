    ...
    <main class="max-w-4xl mx-auto my-4">
        ...
        <section class="relative p-8">
            <div class="flex justify-end space-x-10 items-start"> <!-- justify-end menggeser konten ke kanan -->
                <!-- Gambar Luna -->
                <img src="img/4 TIME TO HEAL NATURE.jpg" alt="TTHN" class="w-56 h-56 object-cover rounded-lg border border-[#5A72A0]"> 
                
                <!-- Informasi Kampanye -->
                <div class="flex-1 max-w-md">
                    <h1 class="text-2xl font-bold mb-2 text-[#5A72A0]">Time to Heal Nature Bumi Perkemahan Panceng Gresik.</h1>
                ...
                <div class="flex-1">
                    ...
                    <div id="kisah-content" style="display: block;">
                        <p style="color: #5A72A0; text-indent: 0.5in; text-align: justify; margin-bottom: 1em;">
                            Time to Heal Nature atau TTHN Merupakan salah satu program dari UKM Peduli Kmeanusiaan, tepatnya divisi mitigasi bencana di bidang penghijauan lingkungan. Bekerja sama dengan perhutani, UKM Peduli Kemanusiaan UNESA berencana melakukan kegiatan salah satunya penanaman pohon/reboisasi di bumi perkemahan Pancen Gersik pada tanggal 11 Mei 2024. UKM Peduli kemanusiaan mendapatkan kesempatan untuk bekerja sama dengan berbagai pihak luar dan melibatkan media liputan. Kegiatan yang dilakukan nantinya ada pennaman bibit, bersih - bersih lingkungan, dan fun games.
                        </p>
                        <p style="color: #5A72A0; text-indent: 0.5in; text-align: justify; margin-bottom: 1em;">
                            Adanya program kerja ini menjadikan kita sebagai mahasiswa untuk lebih terbuka terhadap pentingnya menjaga lingkungan. Karena salah satu tugas mahasiswa adalah sebagai <i>Agent of change</i> , yaitu mahasiswa harus mampu menjadi pion di berbagai aspek, seperti lingkungan.
                        </p>
                        <p style="color: #5A72A0; text-indent: 0.5in; text-align: justify; margin-bottom: 1em;">
                            Nah, buat kalian yang tertarik untuk ikut sebagai relawan bisa banget lho langsung daftar di bagian Voluntrip. Tapi, jangan khawatir kalau kalian berhalangan hadir namun masih tetap ingin berkontribusi terhadap alam. kalian bisa melakukan donasi disini! Apapun yang kalian donasikan baik berupa uang, barang, atau tenaga bisa memberikan dampak jangka panjang bagi bumi dan kita semua!.
                        </p>
                    </div>
                    ...
                    <div id="S&K" style="display: none;">
                        <p style="color: #5A72A0; text-indent: 0.5in; text-align: justify; margin-bottom: 1em;">
                            Voluntrip bersaa #GerakAksi menjadi wadah bagi kamu yang ingin ikut berkontribusi dalam membuat kebaikan. Kali ini Voluntrip bersama UKM Peduli Kemanusiaan UNESA menjadi relawan untuk kegiatan reboisasi di perkemahan Panceng Gresik.
                        </p>
                        <p style="color: #5A72A0; text-indent: 0.5in; text-align: justify; margin-bottom: 1em;">
                        ...
                        <p style="color: #5A72A0; text-indent: 0.5in; text-align: justify; margin-bottom: 1em;">
                            Dengan mengikuti kegiatan Voluntrip ini, kamu sudah ikut menjadi bagian dlam berbuat kebaikan bersama #BestiAksi untuk relawan kegiatan Reboisasi. Yuk, daftar sekarang!
                        </p>
                    </div>                    
                </div>
            </div>
