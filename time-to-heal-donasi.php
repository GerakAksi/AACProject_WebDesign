...
<body>
    ...
    <main class="max-w-4xl mx-auto my-4">
        ...
        const destinationUrl = 'pembayaran-time-to-heal.php'; // Ganti dengan URL halaman pembayaran yang sesuai
                ...
                <div class="flex flex-col lg:flex-row justify-between items-center">
                    ...
                    <div class="flex flex-col lg:flex-row lg:space-x-16">
                        ...
                        <div class="text-center lg:text-left">
                            ...
                            <ul class="space-y-2">
                                <li><a href="home.php" class="text-[#5A72A0] hover:text-gray-900">Home</a></li>
                        ...
                        <div class="text-center lg:text-left mt-6 lg:mt-0">
                            ...
                            <ul class="space-y-2">
                                <li><a href="help-center" class="text-[#5A72A0] hover:text-gray-900">Help Center</a></li>
                                <li><a href="chat-support" class="text-[#5A72A0] hover:text-gray-900">Chat Support</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
