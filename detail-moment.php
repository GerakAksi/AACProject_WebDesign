...
<body>
    ...
    <main class="container mx-auto mt-12 p-4 max-w-4xl">
        <div class="p-6 relative"> <!-- Relative positioning untuk container gambar -->
            
            <!-- Ilustrasi Gambar -->
            <div class="flex justify-center mb-6">
                <img src="img/4 TIME TO HEAL NATURE.jpg" alt="Event Image" class="w-1/4 rounded-lg">
            </div>
            
            <!-- Button Back (Posisi di atas gambar dan tidak terlalu ke pojok) -->
            <div class="absolute left-4 top-2 transform">
            ...
            <h2 class="text-2xl font-bold text-[#5A72A0] text-center">Time to Heal Nature Bumi Perkemahan Panceng Gresik</h2>
            <p style="color: #5A72A0; text-indent: 0.5in; text-align: justify; margin-bottom: 1em;">
                Adanya program kerja Time to Heal Nature pada tanggal 11 Mei lalu, UKM Peduli Kemanusiaan mendapatkan kesempatan untuk bekerja sama dengan berbagai pihak luar dan melibatkan media liputan, lho! Tidak tanggung-tanggung para petinggi pun datang untuk menyaksikan dan ikut serta langsung dalam kolaborasi yang kita tawarkan. Berkelas banget kan?
            </p>
            <p style="color: #5A72A0; text-indent: 0.5in; text-align: justify; margin-bottom: 1em;">
                Time to Heal Nature atau TTTHN merupakan salah satu program dari UKM Peduli Kemanusiaan, tepatnya divisi mitigasi bencana di bidang penghijauan lingkungan. Bekerja sama dengan Perhutani, UKM Peduli Kemanusiaan UNESA melakukan berbagai kegiatan, mulai dari penanaman bibit pohon (reboisasi), bersih-bersih lingkungan, dan fun games outdoor.
            </p>
            <p style="color: #5A72A0; text-indent: 0.5in; text-align: justify; margin-bottom: 1em;">
                Menurut Perhutani Panceng, hutan di Buper Panceng cocok untuk dilakukan reboisasi. Dilihat dari masyarakatnya yang kurang peduli akan hutan dan menganggap hutan tersebut sebagai stigma buruk bagi mereka.
            </p>
    
            <div class="mt-6 flex justify-between items-center">
                <div class="flex items-center space-x-2">
                    <img src="img/UKM PK.png" alt="UNESA Logo" class="w-10 h-10">
                    <span class="text-[#5A72A0]">UKM Peduli Kemanusiaan UNESA</span>
                </div>
                <span class="text-[#5A72A0]">03 September 2024</span>
            </div>
        </div>
    </main>
    ...
    <script>
        ...
        const kategoriAksiUrl = 'create-moment.php';
