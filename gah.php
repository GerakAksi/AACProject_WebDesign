    ...
    <section class="container mx-auto py-12">
        ...
        <div class="bg-[#FEF9D9] shadow-lg rounded-lg py-8 px-12 max-w-4xl mx-auto">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="#" class="text-[#5A72A0] bg-white text-[#5A72A0] px-4 py-2 rounded-full shadow-lg hover:bg-yellow-200">Hewan</a>
            </div>
            ...
            <div class="grid grid-cols-3 gap-6">
                ...
                <div class="bg-white p-6 rounded-lg shadow">
                    <img src="img/2 JAGA SATWA UNESA.jpg" alt="Event 1" class="rounded-lg mb-4 w-full h-48 object-cover">
                    <p class="font-semibold text-[#5A72A0]">Jaga Satwa UNESA</p>
                    ...
                    <button class="bg-[#FEF9D9] text-[#5A72A0] px-4 py-2 mt-4 rounded-full w-full" id="donate1">Donasi</button>
                </div>
            
                <!-- Item 2 -->
                <div class="bg-white p-6 rounded-lg shadow">
                    <img src="img/5 SEMBUHKAN LUNA.jpg" alt="Event 2" class="rounded-lg mb-4 w-full h-48 object-cover">
                    <p class="font-semibold text-[#5A72A0]">Sembuhkan Luna</p>
                    <div class="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700 my-2">
                    ...
                    <button class="bg-[#FEF9D9] text-[#5A72A0] px-4 py-2 mt-4 rounded-full w-full" id="donate2">Donasi</button>
                </div>
            </div>
            ...
            <script>
                ...
                document.getElementById("donate1").addEventListener("click", function() {
                    window.location.href = "jaga-satwa-donasi.php"; // URL for the first event
                });
            
                // Event listener for the second button
                document.getElementById("donate2").addEventListener("click", function() {
                    window.location.href = "luna-donasi.php"; // URL for the second event
                });
            </script>
            </section>
