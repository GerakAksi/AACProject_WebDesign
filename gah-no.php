...
<body>
    ...
    <section class="py-12">
        <div class="container mx-auto px-4">
            <div class="bg-white shadow-lg rounded-lg p-12 mx-auto max-w-4xl">
    ...
    <section class="container mx-auto py-12">
        ...
        <div class="bg-[#FEF9D9] shadow-lg rounded-lg py-8 px-12 max-w-4xl mx-auto">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="#" class="text-[#5A72A0] bg-white text-[#5A72A0] px-4 py-2 rounded-full shadow-lg hover:bg-yellow-200">Lihat lainnya</a>
            </div>
