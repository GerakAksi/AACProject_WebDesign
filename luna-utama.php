            ...
            <div class="flex justify-end space-x-10 items-start"> <!-- justify-end menggeser konten ke kanan -->
                ...
                <div class="flex-1 max-w-md">
                    ...
                    <script>
                        ...
                        const donasiUrl = 'luna-donasi.php'; // Ganti dengan URL donasi yang sesuai
                ...
                <script>
                    ...
                    const kategoriAksiUrl = 'C:/Users/HP/Documents/PEM WEB/HOMEPAGE No Login/homepage.html';
                ...
                <div class="flex-1">
                    ...
                    <div id="kisah-content" style="display: block;">
                        <p style="color: #5A72A0; text-indent: 0.5in; text-align: justify; margin-bottom: 1em;">
                            Luna adalah korban tabrak lari, hingga patah tulang parah. Tidak ada saksi mata yang bisa mengamati pelaku atau bahkan memberhentikannya. Luna ditemukan oleh penjual <i>Food Court</i> di dalam got tidak bisa bergerak.
                        </p>
                        <p style="color: #5A72A0; text-indent: 0.5in; text-align: justify; margin-bottom: 1em;">
                            Luna tinggal di area danau/buzem kampus UNESA Ketintang. Luna beberapa kali pergi ke area <i>Food Court</i> sekedar untuk mencari makan dan bertemu teman-teman lainnya. Luna cenderung kucing yang pendiam. Setelah sarapan, biasanya dia menghabiskan waktu untuk bersantai sambil <i>grooming</i>. Luna baik, tidak pernah mengganggu aktivitas manusia; dia juga sering menemani mahasiswa yang sedang duduk santai di pinggir danau. Entah mengapa manusia malah tega melukainya tanpa bertanggung jawab.
                        </p>
                        <p style="color: #5A72A0; text-indent: 0.5in; text-align: justify; margin-bottom: 1em;">
                            Pada tanggal 23 Januari 2024 pukul 07.10 WIB, Luna ditabrak dan tergeletak lemas serta gemetar. Badannya basah dan kotor. Luna tidak sanggup menggerakkan kaki belakangnya. Tim Jaga Satwa langsung membawa Luna ke vet untuk mendapatkan pemeriksaan sesegera mungkin. Hasil rontgen menunjukkan ada fraktur pada bagian iliosacrum dexter, os. ilium dexter, os. ischium, dan os. pubis. Terdapat penumpukan feses pada usus besar kantung urin berisi cukup banyak (khawatir ada komplikasi pada saraf). Sehingga, dirujuk ke dokter bedah tulang di RSHP Wijaya Kusuma. Biaya pengobatan Luna diperkirakan menyentuh angka Rp. 15 Juta lebih karena harus dipasang pen pada bagian yang patah.
                        </p>
                        <p style="color: #5A72A0; text-indent: 0.5in; text-align: justify; margin-bottom: 1em;">
                            Dengan segala kerendahan hati, kami ingin meminta tolong untuk mengulurkan tangan #GerakAksi demi kesembuhan Luna.
                        </p>
                    </div>
                        ...
                        <ul class="mt-4 space-y-4">
                            <li class="flex justify-between items-center border-b border-[#5A72A0] pb-2 mb-2">
                                <div class="flex items-center">
                                    <img src="img/1 JAM PERIKSA DOKTER.png" alt="Jasa Periksa Dokter" class="w-5 h-5 mr-4" />
                                    <span class="text-[#5A72A0]">Jasa Periksa Dokter</span>
                                </div>
                                <span class="text-[#5A72A0]">Rp 1.500.000</span>
                            </li>
                            <li class="flex justify-between items-center border-b border-[#5A72A0] pb-2 mb-2">
                                <div class="flex items-center">
                                    <img src="img/2 RAWAT INAP.png" alt="Rawat Inap" class="w-5 h-5 mr-4" />
                                    <span class="text-[#5A72A0]">Rawat Inap</span>
                                </div>
                                <span class="text-[#5A72A0]">Rp 7.000.000</span>
                            </li>
                            <li class="flex justify-between items-center border-b border-[#5A72A0] pb-2 mb-2">
                                <div class="flex items-center">
                                    <img src="img/3 RONTGEN KAKI.png" alt="Rontgen Kaki" class="w-5 h-5 mr-4" />
                                    <span class="text-[#5A72A0]">Rontgen Kaki</span>
                                </div>
                                <span class="text-[#5A72A0]">Rp 1.500.000</span>
                            </li>
                            <li class="flex justify-between items-center border-b border-[#5A72A0] pb-2 mb-2">
                                <div class="flex items-center">
                                    <img src="img/4 PASANG PEN.png" alt="Pasang PEN" class="w-5 h-5 mr-4" />
                                    <span class="text-[#5A72A0]">Pasang PEN</span>
                                </div>
                                <span class="text-[#5A72A0]">Rp 6.000.000</span>
                            </li>
                            <li class="flex justify-between items-center border-b border-[#5A72A0] pb-2 mb-2">
                                <div class="flex items-center">
                                    <img src="img/5 OBAT MINUM.png" alt="Obat Minum" class="w-5 h-5 mr-4" />
                                    <span class="text-[#5A72A0]">Obat Minum</span>
                                </div>
                                <span class="text-[#5A72A0]">Rp 1.500.000</span>
                            </li>
                            <li class="flex justify-between items-center border-b border-[#5A72A0] pb-2 mb-2">
                                <div class="flex items-center">
                                    <img src="img/6 WET FOOD.png" alt="Wet Food" class="w-5 h-5 mr-4" />
                                    <span class="text-[#5A72A0]">Wet Food</span>
                                </div>
                                <span class="text-[#5A72A0]">Rp 1.000.000</span>
                            </li>
                            <li class="flex justify-between items-center border-b border-[#5A72A0] pb-2 mb-2">
                                <div class="flex items-center">
                                    <img src="img/7 VITAMIN.png" alt="Vitamin" class="w-5 h-5 mr-4" />
                                    <span class="text-[#5A72A0]">Vitamin</span>
                                </div>
                                <span class="text-[#5A72A0]">Rp 1.500.000</span>
                            </li>
                        </ul>
