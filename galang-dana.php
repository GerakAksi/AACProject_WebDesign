    ...
    <p class="text-lg mb-0 px-8 text-[#5A72A0]">Program <strong>Galang Dana</strong> dari #GerakAksi hadir untuk<br>memudahkan komunitas dan masyarakat yang ingin berkontribusi<br>dalam berbagai aksi sosial. Mulai dari bantuan di bidang pendidikan,<br> lingkungan, perlindungan hewan, hingga kemanusiaan.</p>
                  ...
                  <div id="mahasiswa-content" style="display: block;">
                      ...
                      <div>
                          ...
                          <div class="flex justify-center mt-4">
                              <button id="mahasiswa-btn" onclick="redirectToPage('mahasiswa')" class="px-6 py-2 bg-[#FEF9D9] text-[#5A72A0] rounded-full font-semibold">Mulai Galang Dana Mahasiswa</button>
                          </div>
                      </div>
                  </div>
                  ...
                  <div id="umum-content" style="display:none;">
                      ...
                      <div>
                          ...
                          <div class="flex justify-center">
                              <button id="umum-btn" onclick="redirectToPage('umum')" class="px-6 py-2 bg-[#FEF9D9] text-blue-900 rounded-full font-semibold">Galang Dana Umum Sekarang</button>
                          </div>
                      </div>
                  </div>
              </div>
      ...
      <script>
        function redirectToPage(pageType) {
            ...
            if (pageType === 'mahasiswa') {
                targetPage = 'from-gd-mahasiswa.php'; // Replace with the actual path
            } else if (pageType === 'umum') {
                targetPage = 'from-gd-umum.php'; // Replace with the actual path
            }
    
            // Redirect to the determined target page
            if (targetPage) {
        ...
        <div class="flex flex-col lg:flex-row justify-between items-center">
            ...
            <div class="flex flex-col lg:flex-row lg:space-x-16">
                <div class="text-center lg:text-left">
                    ...
                    <ul class="space-y-2">
                        <li><a href="homepage.php" class="text-[#5A72A0] hover:text-gray-900">Home</a></li>
