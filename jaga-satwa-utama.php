    ...
    <main class="max-w-4xl mx-auto my-4">
        ...
        <section class="relative p-8">
            <div class="flex justify-end space-x-10 items-start"> <!-- justify-end menggeser konten ke kanan -->
                <!-- Gambar Luna -->
                <img src="img/2 JAGA SATWA UNESA.jpg" alt="Luna" class="w-56 h-56 object-cover rounded-lg border border-[#5A72A0]"> 
                
                <!-- Informasi Kampanye -->
                <div class="flex-1 max-w-md">
                    <h1 class="text-2xl font-bold mb-2 text-[#5A72A0]">Jaga Satwa UNESA x Kitty Cat Food</h1>
                    ...
                    <script>
                        ...
                        const donasiUrl = 'jaga-satwa-donasi.php'; // Ganti dengan URL donasi yang sesuai
                ...
                <div class="flex-1">
                    ...
                    <div id="kisah-content" style="display: block;">
                        <p style="color: #5A72A0; text-indent: 0.5in; text-align: justify; margin-bottom: 1em;">
                            Weekend nanti tepatnya tanggal 3 Desember Tim Jaga Satwa mengadakan <i>Weekend With UrbanMiaww Vol.2!</i>UrbanMiaww adalah Kegiatan <i>Street Feeding</i>Warbul UNESA yang bertujuan untuk menjaga hubungan baik hooman  dengan Warbul UNESA dan menjaga populasi anabul yang kini kian memburuk karena banyak yang terlantar/dibiarkan begitu saja. 
                        </p>
                        <p style="color: #5A72A0; text-indent: 0.5in; text-align: justify; margin-bottom: 1em;">
                            Berbagi membuat mereka dapat merasakan kehidupan yang lebih aman, sehat, dan sejahtera. Sedikit rezeki dari kalian berarti seumur hidup bagi anabul UNESA! Mari bergerak bersama menciptakan kehidupan satwa yang sejahtera.
                        </p>
                    </div>
                        ...
                        <ul class="mt-4 space-y-4">
                            <li class="flex justify-between items-center border-b border-[#5A72A0] pb-2 mb-2">
                                <div class="flex items-center">
                                    <img src="img/1 JASA PERIKSA DOKTER.png" alt="Jasa Periksa Dokter" class="w-5 h-5 mr-4" />
                            ...
                            <li class="flex justify-between items-center border-b border-[#5A72A0] pb-2 mb-2">
                                <div class="flex items-center">
                                    <img src="img/2 JAGA STERIL.png" alt="Rawat Inap" class="w-5 h-5 mr-4" />
                                    <span class="text-[#5A72A0]">Jaga Steril</span>
                                </div>
                                <span class="text-[#5A72A0]">Rp 5.000.000</span>
                            </li>
                            <li class="flex justify-between items-center border-b border-[#5A72A0] pb-2 mb-2">
                                <div class="flex items-center">
                                    <img src="img/3 VAKSIN.png" alt="Rontgen Kaki" class="w-5 h-5 mr-4" />
                                    <span class="text-[#5A72A0]">Vaksin</span>
                                </div>
                                <span class="text-[#5A72A0]">Rp 3.500.000</span>
                            </li>
                            <li class="flex justify-between items-center border-b border-[#5A72A0] pb-2 mb-2">
                                <div class="flex items-center">
                                    <img src="img/4 MAKANAN KUCING.png" alt="Pasang PEN" class="w-5 h-5 mr-4" />
                                    <span class="text-[#5A72A0]">Makanan Kucing</span>
                                </div>
                                <span class="text-[#5A72A0]">Rp 4.500.000</span>
                            </li>
                        </ul>
                    </div>                    
                </div>
