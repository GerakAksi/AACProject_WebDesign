...
$sql = "INSERT INTO gd_mahasiswa (siapa, email, dokumen_pendukung, tujuan, perkiraan_biaya, masa, masa_lain, judul, foto_cover, rincian, detail) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

$stmt = $conn->prepare($sql);
$stmt->bind_param("ssssssissss", $siapa, $email, $dokumen_pendukung, $tujuan, $perkiraan_biaya, $masa, $masa_lain, $judul, $foto_cover, $rincian, $detail);
