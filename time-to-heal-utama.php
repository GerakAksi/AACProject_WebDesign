    ...
    <main class="max-w-4xl mx-auto my-4">
        ...
        <section class="relative p-8">
            <div class="flex justify-end space-x-10 items-start"> <!-- justify-end menggeser konten ke kanan -->
                <!-- Gambar Luna -->
                <img src="img/4 TIME TO HEAL NATURE.jpg" alt="Luna" class="w-56 h-56 object-cover rounded-lg border border-[#5A72A0]"> 
                ...
                <div class="flex-1 max-w-md">
                    ...
                    <script>
                        ...
                        const donasiUrl = 'time-to-heal-donasi.php'; // Ganti dengan URL donasi yang sesuai
                        ...
                        <ul class="mt-4 space-y-4">
                            ...
                            <li class="flex justify-between items-center border-b border-[#5A72A0] pb-2 mb-2">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-[#5A72A0]">Prgram edukasi kesadaran Lingkungan</span>
                                </div>
                                <span class="text-[#5A72A0]">Rp 2.500.000</span>
                            </li>
                        </ul>
