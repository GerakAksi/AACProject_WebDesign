    ...
    <div class="flex justify-center items-start min-h-screen mt-[-2rem]">
        <div class="bg-white p-6 rounded-lg shadow-lg max-w-4xl w-full flex">
            ...
            <div class="flex flex-col items-start w-3/4 pl-6">
                <div class="mb-4">
                    <h3 class="font-semibold text-xm text-[#5A72A0]">Penggalangan Dana Saya</h3>
                    <p class="font-semibold text-xs text-[#5A72A0]">Kamu bisa melihat perkembangan galang dana-mu disini</p>
                    <div class="flex justify-center items-center h-40">
                        <img src="img/4 PENGGALANGAN DANA SAYA.png" alt="Galang Dana" class="w-20 h-20">
                    </div>
                    <p class="text-xs text-[#5A72A0] text-center">Kamu belum membuka penggalangan dana apapun</p>
                </div>
            </div>
        </div>
    </div>
