    ...
    <section class="container mx-auto py-12">
        ...
        <div class="bg-[#FEF9D9] shadow-lg rounded-lg py-8 px-12 max-w-4xl mx-auto">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="#" class="text-[#5A72A0] bg-white text-[#5A72A0] px-4 py-2 rounded-full shadow-lg hover:bg-yellow-200">Sosial</a>
            </div>
            ...
            <div class="grid grid-cols-3 gap-6">
                ...
                <div class="bg-white p-6 rounded-lg shadow">
                    ...
                    <p class="font-semibold text-[#5A72A0]">Time to heal Nature</p>
                ...
                <!-- Item 2 -->
                <div class="bg-white p-6 rounded-lg shadow">
                    <img src="img/6 UNESA PEDULI LUMAJANG.jpg" alt="Event 2" class="rounded-lg mb-4 w-full h-48 object-cover">
                    <p class="font-semibold text-[#5A72A0]">UNESA Peduli Lumajang</p>
                    <div class="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700 my-2">
                    ...
                    <button id="donate2" class="bg-[#FEF9D9] text-[#5A72A0] px-4 py-2 mt-4 rounded-full w-full">Donasi</button>
                </div> 
            </div>
        </section>
        
        <script>
            // Event listener for the first button (Jaga Satwa UNESA)
            document.getElementById("donate1").addEventListener("click", function() {
                // Redirect to the donation page directly
                window.location.href = "time-to-heal-donasi.php"; // Replace with your actual donation page URL
            });
        
            // Event listener for the second button (Sembuhkan Luna)
            document.getElementById("donate2").addEventListener("click", function() {
                // Redirect to the donation page directly
                window.location.href = "peduli-lumajang-donasi.php"; // Replace with your actual donation page URL
            });
        </script>
